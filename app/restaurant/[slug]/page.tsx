				...
				<div className='bg-white w-[70%] rounded p-3 shadow'>
					...
					<div className='mt-4'>
						<p className='text-lg font-light'>
							The classics you love prepared with a perfect twist,
							all served up in an atmosphere that feels just
							right. That’s the Milestones promise. So, whether
							you’re celebrating a milestone, making the most of
							Happy Hour or enjoying brunch with friends, you can
							be sure that every Milestones experience is a simple
									...
									<div className='ml-10 w-5/6'>
										...
										<div className='mt-5'>
											<p className='text-lg font-light'>
												...
												Slow night due to the snow storm
												so it worked in our favor to
												have more one on one with the
												staff. Delicious and well worth
												the money.
											</p>
										</div>
									</div>
